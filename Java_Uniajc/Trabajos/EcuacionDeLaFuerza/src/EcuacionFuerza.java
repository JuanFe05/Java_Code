...
public class EcuacionFuerza {
    ...
    public void ecuacionDeLaFuerza() {
        ...
        System.out.println("El resultado de la ecuación de la fuerza donde, la masa " +
                "es: " + this.masa + " y la aceleración es: " + this.aceleracion + " da como resultado una fuerza de: " + fuerza);
    }
}
